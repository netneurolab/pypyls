...
Usage
-----
See the :ref:`Usage <usage_ref>` or the :ref:`API reference <api_ref>` for
information on how to get started with this package.


License Information
-------------------
This codebase is licensed under version 2 of the GNU General Public License.
The full license can be found in the `LICENSE`_ file in the ``pyls``
distribution.
